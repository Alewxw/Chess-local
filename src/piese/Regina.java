...
public class Regina extends Piesa{
    ...
    public Regina ( String culoare, String tip )
    {
        super(culoare, tip);
    }

    public Regina( String culoare, String tip, int rand, int coloana )
    {
    ...
    {
        return (Math.abs(rand - getRand()) == Math.abs(coloana - getColoana()) ) || (rand == this.getRand() || coloana == this.getColoana());
    }
}
